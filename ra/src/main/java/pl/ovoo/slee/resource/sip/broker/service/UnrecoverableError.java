...
/**
 * To be thrown when there is no standard way to handle the exceptional case
 */
public class UnrecoverableError extends Exception {
    public UnrecoverableError(Throwable e){
        super(e);
    }
    ...
    public UnrecoverableError(String message, Throwable e){
        super(message, e);
    }
}
